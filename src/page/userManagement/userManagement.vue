                  ...
                  >
                    ...
                    >
                      <el-row
                        ...
                        :gutter="0"
                        class="__p_137_u_360"
                        v-for="(item, index) in studentStatusInformation"
                        :key="index"
                      >
                        <el-col
                          :span="12"
                    ...
                    <el-col :span="12" :offset="0" :push="0" :pull="0">
                      ...
                      >
                        <el-col
                          ...
                          :pull="0"
                          class="__p_137_u_273"
                          ><span class="__p_137_u_274">招生信息</span></el-col
                        >
                      </el-row>
                    </el-col>
                  </el-row>
                  ...
                  >
                    ...
                    >
                      <el-row
                        ...
                        :gutter="0"
                        class="__p_137_u_360"
                        v-for="(item, index) in admissionsInformation"
                        :key="index"
                      >
                        <el-col
                          :span="12"
  ...
  methods: {
    goQuickConfig() {
      this.rjDialog
        .title("快速配置")
        .width("1100px")
        .currentView(personMessage, { routeType: "static" })
        .showClose(true)
        .sizeTiny()
