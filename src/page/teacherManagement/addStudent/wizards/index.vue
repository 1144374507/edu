    ...
    <div v-else>
      <el-card>
        <el-steps :active="activeStep" simple class="m-simple-steps">
          <el-step title="基础信息" icon="custom-icon-1" :class="{'m-active-step': activeStep === 1}"></el-step>
          <el-step title="联系方式" icon="custom-icon-2" :class="{'m-active-step': activeStep === 2}"></el-step>
          <el-step title="个人简介" icon="custom-icon-3" :class="{'m-active-step': activeStep === 3}"></el-step>
        </el-steps>
      </el-card>
      <div class="content-wrapper">
        <div>
          ...
          <deploy-finish  v-if="activeStep === 4" @preStep="handlePreStep" @nextStep="handleNextStep"></deploy-finish>
        </div>
      </div>
    </div>
  </div>
