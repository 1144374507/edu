        ...
        <div>
            ...
            <el-row :gutter="16">
                <el-col :span="8">
                    <div
                        class="__p_12e_u_60"
                        id="qa-test-customize"
                        :class="{ 'm-cursor': allowEditItem }"
                        @click="handleStep1Click"
                    >
                        <img
                ...
                <el-col :span="8">
                    ...
                    >
                        ...
                        <div class="__p_12e_u_67">
                            <span class="__p_12e_u_68">② 入学信息</span>
                        </div>
                    </div>
                </el-col>
                <el-col :span="8">
...
.__p_12e_u_60 {
    background: #ffffff;
    border-radius: 12px;
    box-shadow: 4.02px 4.02px 12.85px rgba(237, 246, 252, 0.7);
    text-align: center;
    top: 0;
...
.__p_12e_u_74 {
    ...
    border-radius: 36px;
    background: #026df7;
    box-shadow: 0px 5.33px 8px rgba(2, 109, 247, 0.2);
}
...
.theme-18edd0 {
    ...
    .__p_12e_u_65,
    .__p_12e_u_69 {
        background: linear-gradient(0deg, #282d3c, #304054);
        border: 1px solid rgba(110, 127, 151, 0.2);
        box-shadow: none;
        border-radius: 2px;
    }
    .__p_12e_u_58 {
