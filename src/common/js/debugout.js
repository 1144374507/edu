...
function debugout() {
	...
	self.logFilename = 'front_log.txt'; // filename of log downloaded with downloadLog()
	...
	*/
	...
	this.isLog = (flag) => {
		if(flag) {
			localStorage.setItem("is_log_info_to_file", "true");
		} else {
			
			localStorage.removeItem("is_log_info_to_file");
		}
	}
	this.checkIsLog = () => {
		let flag = localStorage.getItem("is_log_info_to_file");
