  ...
  <div>
    <div class="__p_YR_u_2">
      <el-steps :active="active" align-center class="__p_YR_u_13">
        ...
        <el-step title="终端接口"></el-step>
        <el-step title="交换机接口"></el-step>
        <el-step title="安全"></el-step>
        <el-step v-if="mode === 'l3'" title="路由器接口"></el-step>
        <el-step v-if="mode === 'l3'" title="下联端口配置"></el-step>
      </el-steps>
      <el-form label-position="left">
        ...
        <routerInterface ref="routerInterface"  v-show="active === 4"></routerInterface>
        <lowerInterface ref="lowerInterface" v-show="active === 5"></lowerInterface>
      </el-form>
      <!-- 控制流程 -->
      <div class="__p_YR_u_19" v-show="active !== steps">
        <el-button @click="goOut" type="default" size="small">退出快速配置</el-button>
        <div>
      ...
      <div class="__p_YZ_u_2" v-show="active === steps && !isSuccess">
        ...
        <div class="__p_YZ_u_5"><span class="__p_YZ_u_6">配置下发中，请稍候</span><span class="__p_YZ_u_11">请不要执行任何操作，也不要刷新或关闭本页面。</span></div>
      </div>  
       <!-- 配置完成 -->
      <div class="__p_Z0_u_10" v-show="isSuccess">
        <div class="__p_Z0_u_11"><i class="el-icon-check __p_Z0_u_17"></i></div>
        <div class="__p_Z0_u_13"><span class="__p_Z0_u_14">已完成快速配置</span>
    ...
    methods: {
      ...
      finish() {
        ...
        const reqData = {
          ...
          interface:deviceManagement.mask,
